            ...
            <div class="block">
              ...
              <div class="block__content">
                <div class="articles articles__horizontal">
								...
								$articles = mysqli_query($connection, "SELECT * FROM `articles` ORDER BY `id` DESC LIMIT 10 $offset, $per_page");

								$articles = mysqli_query(
									$connection, "SELECT * FROM `articles` ORDER BY `id` DESC LIMIT $offset, $per_page");
                    ...
                    <div class="article__info">
                      ...
                      <div class="article__info__preview"><?php echo mb_substr(strip_tags($art['text']), 0, 80, 'utf-8') . ' ...'; ?></div>
									...
									if (!$articles_exist) {
										...
										if ($page < $total_pages) {
											echo '<a href="/articles.php?page=' . ($page + 1) . ' ">Прошлая страница &raquo;</a>';
											}
										echo '</div>';
									}
									?>
